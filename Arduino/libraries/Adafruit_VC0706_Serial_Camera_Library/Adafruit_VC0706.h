...
#define VC0706_1600x1200 0x77
#define VC0706_2304x1296 0x88
...
public:
  ...
  uint8_t *readPicture(uint8_t n, uint8_t hex1);
  boolean resumeVideo(void);
  uint32_t frameLength(uint8_t hex1);
  ...
  boolean setWhiteBalance(uint8_t wbflag, uint8_t hex1, uint8_t hex2);
  boolean takePictureManual(uint8_t hex1, uint8_t hex2);
  boolean takeMultiPic(uint8_t hex1, uint8_t hex2, uint8_t hex3);
  void resetframeptr(void);
