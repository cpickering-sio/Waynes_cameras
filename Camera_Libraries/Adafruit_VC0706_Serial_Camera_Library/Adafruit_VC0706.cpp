...
*/
/**************************************************************************/
uint32_t Adafruit_VC0706::frameLength(uint8_t hex1) {
  uint8_t args[] = {0x01, hex1};
...
*/
/**************************************************************************/
uint8_t *Adafruit_VC0706::readPicture(uint8_t n, uint8_t hex1) {
  uint8_t args[] = {0x0C,
                    hex1,
                    0x0A,
...
/*!
    ...
    @param See datasheet for White Balance settings
    @returns True on command success
*/
/**************************************************************************/
boolean Adafruit_VC0706::setWhiteBalance(uint8_t wbflag, uint8_t hex1, uint8_t hex2) {
uint8_t args[] = {0x0C, 0x04, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, wbflag, hex1, hex2, 0x80, 0x04};
return runCommand(0x91, args, sizeof(args), 6);
}


/**************************************************************************/
/*!
My own Take Picture Command
*/
/**************************************************************************/
boolean Adafruit_VC0706::takePictureManual(uint8_t hex1, uint8_t hex2) {
frameptr = 0;
uint8_t args[] = {hex1, hex2};
...
/**************************************************************************/
/*!
My own Multi Pic Command
*/
/**************************************************************************/
boolean Adafruit_VC0706::takeMultiPic(uint8_t hex1, uint8_t hex2, uint8_t hex3) {
frameptr = 0;
uint8_t args[] = {0x03, hex1, hex2, hex3};
return runCommand(0x88, args, sizeof(args), 5);
}


/**************************************************************************/
/*!
Reset frameptr TEST ONLY
*/
/**************************************************************************/
void Adafruit_VC0706::resetframeptr(void) {
frameptr = 0;
}
